...
class OpenRouterProvider {
     ...
     */
    async analyzeWithModel(description, context, model) {
     ...
     */
    async generateWithModel(analysis, template, model) {
     ...
     */
    async validateWithModel(code, rules, model) {
     ...
     */
    async refactorWithModel(code, issues, model) {
